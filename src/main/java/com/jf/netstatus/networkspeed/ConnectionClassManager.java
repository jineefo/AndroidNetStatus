...
public class ConnectionClassManager {
  ...
  public static int  DEFAULT_SAMPLES_TO_QUALITY_CHANGE = 5;
  private static final int BYTES_TO_BITS = 8;
  /**
   * 设置默认速率kbs
   */
  private  int DEFAULT_POOR_BANDWIDTH = 150;
  private  int DEFAULT_MODERATE_BANDWIDTH = 550;
  private  int DEFAULT_GOOD_BANDWIDTH = 2000;

  public  void setDefaultPoorBandwidth(int defaultPoorBandwidth) {
    DEFAULT_POOR_BANDWIDTH = defaultPoorBandwidth;
  }

  public  void setDefaultModerateBandwidth(int defaultModerateBandwidth) {
    DEFAULT_MODERATE_BANDWIDTH = defaultModerateBandwidth;
  }

  public  void setDefaultGoodBandwidth(int defaultGoodBandwidth) {
